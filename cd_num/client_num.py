...
def procesar_request(proxy, request):
    ...
    try:
        ...
        result = proxy.comprar_entrada(client_id, seat_id, request_id)
    except Exception:
...
def main():
    ...
    request_file = Path(__file__).resolve().parent / "../data/benchmark_numbered_60000.txt"
    ...
    try:
        server_name = "ticket.server.numbered"
